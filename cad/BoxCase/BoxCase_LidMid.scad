...
difference()
{
	...
	union()
	{
        ...
        color("blue") rotate([0, 0, 90])  translate([-3.5,-j+(i == 0 ? 10 : -10),0])  {
			...
			{
              // Cut Y panel hole
				translate([0, backX > 0 ? (i == 90 ? -10.5 : 10.5) : (i == 90 ? -1 : 1), height/2])
				cube([pillarSize, sidePanelYWidth+(backX > 0 ? -21 : 0), height], center=true);
                
                if (backX > 0) translate([0, i == 90 ? 41 : -41, height/2])
